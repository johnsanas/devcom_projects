...
<head>
	<title>MMU | FINAL QUESTION AND ANSWER</title>
		...
		<div class="categoryHome">
			...
			<div class="contentMain">
				<div class="instructions">
					<p>Final Question and Answer category has a 50% part on the overall judging process. Each criteria has a   corresponding maximum score given.
