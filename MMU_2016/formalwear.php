...
<head>
	<title>MMU | FORMAL WEAR</title>
	<?php include("header.php"); ?>
</head>

<body class="formalwearBC">
		...
		<div class="categoryHome">
			...
			<div class="contentMain">
				<div class="instructions">
					<p>Formal wear category has a 20% part on the overall judging process. Each criteria has a   corresponding maximum score given.
