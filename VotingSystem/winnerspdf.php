...
<?php
	...
	if (mysqli_num_rows($result)>0){
		...
		while ($rows = mysqli_fetch_array($result)){
			...
			$pdf->Cell(20,10,$countrow['bilang'].'/'.$collegecountrow['lahat'],1,0,"C");
			$pdf->Cell(20,10,(round(($countrow['bilang']/$collegecountrow['lahat'])*100,2)).'%',1,0,"C");
			...
			$pdf->SetFont('Arial','B',10);
			$pdf->Cell(20,10,"NIÑA NICAH MARIANO",0,0,"");$pdf->ln(5);
